					...
					<div class="mainmenu text-center">
						<nav>
							<ul id="nav">
								...
								<li>
									<a href="shop.html">FEATURED</a>
								</li>
								<li>
									<a href="shop.html">REVIEW BOOK</a>
								</li>
								<li>
									<a href="shop.html">ABOUT AUTHOR</a>
								</li>
								<li>
									<a href="shop.html">TESTIMONIAL</a>
								</li>
								<li>
									...
									<ul class="sub-menu">
										...
										<li>
											<a href="shop.html">Shopping Page</a>
										</li>
										<li>
											<a href="single-product.html">Single Shop Page</a>
										</li>
										<li>
							...
							<c:forEach var="row" items="${basketList }" varStatus="i">
								<tr>
									...
									<td class="product-image">
										<a href="#">
											<img src="<%=cp %>/upload/${row.basket_book_image }" alt="">
										</a>
									</td>
									...
									<td class="product-unit-price">
										<p>${row.basket_book_price*row.basket_book_count}</p>
									</td>
