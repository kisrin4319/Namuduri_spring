...
<body>
								...
								<div class="col-sm-12">
									<div class="row">
										<div class="col-sm-6 form-group">
											<label>BOOK NUMBER</label> <input type="text" name="book_num" placeholder="Book Number Here.." class="form-control" value="${usedBook.book_num }" readonly>
										</div>
										<div class="col-sm-6 form-group">
											<label>BOOK_NAME</label> <input type="text" name="book_name" placeholder="Book Name Here.." class="form-control" value="${usedBook.book_name }" readonly>
										</div>
									</div>
									<div class="form-group">
										<label>BOOK_CATEGORY</label> <input type="text" name="book_category" placeholder="Book Category Here.." class="form-control" value="${usedBook.book_category }" readonly>
									</div>
									<div class="row">
										<div class="col-sm-4 form-group">
											<label>BOOK_IMAGE</label> <input type="text" name="book_image" placeholder="Book Image Here.." class="form-control" value="${usedBook.book_image }" readonly> <img id="image" src="<%=cp%>/upload/${usedBook.book_image }" width="200px" height="300px" style="display: block; margin-left: auto; margin-right: auto;" />
										</div>
										<div class="col-sm-4 form-group">
											<label>BOOK_AUTH</label> <input type="text" name="book_auth" placeholder="Book Auth Here.." class="form-control" value="${usedBook.book_auth }" readonly>
										</div>
										<div class="col-sm-4 form-group">
											<label>COMPANY_ID</label> <input type="text" name="company_id" placeholder="Company ID Here.." class="form-control" value="${usedBook.company_id }" readonly>
										</div>
										<div class="col-sm-8 form-group">
											<label>ORIGIN PRICE</label> <input type="text" name="book_price" placeholder="Origin Price Here.." class="form-control" value="${usedBook.book_price }" readonly>
										</div>
										<div class="col-sm-8 form-group">
											<label>NEW PRICE</label> <input type="text" name="book_new_price" placeholder="Enter New Price Here.." class="form-control" value="${usedBook.book_new_price }">
										</div>
										<div class="col-sm-8 form-group">
	...
	<script type="text/javascript">
		...
		$('input[type="checkbox"][name="used_book_status"]').click(function() {
			//클릭 이벤트 발생한 요소가 체크 상태인 경우
			if ($(this).prop('checked')) {
				//체크박스 그룹의 요소 전체를 체크 해제후 클릭한 요소 체크 상태지정
				$('input[type="checkbox"][name="used_book_status"]').prop('checked',false);
