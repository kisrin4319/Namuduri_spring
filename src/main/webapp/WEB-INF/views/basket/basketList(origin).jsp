											...
											<tbody>
												<c:forEach var="row" items="${basketList }" varStatus="i">
													...
													<tr>
														...
														<td align="center">
															<a href="#this" onclick="singleOrder(${row.basket_book_num}, ${row.basket_book_count}, ${row.basket_num})" class="skinbtn point1 cart-orderselect" style="width: 85px; height: 45px; line-height: 50px; background-color: #5e6b9f; color: #ffffff">바로구매</a>
									...
									<p>
										...
										<span id="deliveryCalculateNone">
											...
											<strong id="totalDeliveryCharge">
												<input type="text" id="fee" value="0" size="4" style="text-align: right; border: 0; vertical-align: baseline; font-size: medium;" />
											</strong>
											원
										</span>
										<span class="total">
