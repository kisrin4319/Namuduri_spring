...
<!-- Bootstrap Core CSS -->
<link href="<%=cp%>/adminBootStrap/css/bootstrap.min.css" rel="stylesheet">
...
<link href="<%=cp%>/adminBootStrap/css/blue.css" id="theme" rel="stylesheet">

<!-- chartist CSS -->
<link href="<%=cp%>/adminBootStrap/css/chartist.min.css" rel="stylesheet">
<link href="<%=cp%>/adminBootStrap/css/chartist-init.css" rel="stylesheet">
<link href="<%=cp%>/adminBootStrap/css/chartist-plugin-tooltip.css" rel="stylesheet">

<link href="<%=cp%>/css/adminPage.css?ver=1" rel="stylesheet" type="text/css" />
...
<body>
	<nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
		<div class="navbar-header">
			<a class="navbar-brand" href="<%=cp%>/main.do"> <!-- <b><img src="../assets/images/logo-light-icon.png" alt="homepage" class="light-logo" /></b>
