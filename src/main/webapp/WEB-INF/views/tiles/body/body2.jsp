								...
								<div class="event_banner" style="height: 320px;margin-left: 15px;width: 900px;">
									...
									<a class="link_book item_3" href="textbookDetail.do?goods_num=24">
										...
										<img src="/namuduri/admin/upload/textbook_1507408683032.jpg" alt="신과 함께 박스 세트(개정판)(전8권)" />
										 <strong class="title">신과 함께 박스 세트(개정판)(전8권)</strong> <span class="info">몇번이나 보았지만 소장까지 하고 싶게 만드는 몇 안되는 웹툰입니다. - ma**ewjj님</span>
									</a> 
									<a class="link_book item_3" href="textbookDetail.do?goods_num=11">
										...
										<strong	class="title">82년생 김지영(오늘의 젊은 작가 13)(양장본 HardCover)</strong> <span class="info">받은 즉시 하루만에 다 읽었어요,! 여자로서 너무 공감가는 이야기에요- me**0512님</span>
									</a>
									<a class="link_book item_3" href="textbookDetail.do?goods_num=25">
										...
										<strong class="title">엄마 반성문</strong> <span class="info">전교 일등 남매 고교 자퇴 후 코칭 전문가 된 교장 선생님의 고백</span>
									</a>
									<a class="link_book item_3" href="textbookDetail.do?goods_num=16">
										...
										<strong class="title">남아 있는 나날</strong> <span class="info">2017 노벨 문학상 수상작가 "가즈오 이시구로" 대표작</span>
									</a>
								</div>
							</li>	
						</ul>
					...
					<li class="best1" >
						...
						<div class="cover">
							<a href="textbookDetail.do?goods_num=9">
								...
								<div>
								<em>
												김영하의 장편소설 『살인자의 기억법』. 《너의 목소리가 들려》 이후 일 년 반 만에 펴낸 장편소설로...
								</em>
									<span/>
								</div>
							</a>
					...
					<li class="best2" >
						...
						<div class="cover">
							<a href="textbookDetail.do?goods_num=10">
								...
								<div><em>
												언어에는 따뜻함과 차가움, 적당한 온기 등 나름의 온도가 있다. 세상살이에 지칠 때 어떤 이는 친구...
								</em><span></span></div>
							</a>
						</div>
						<div class="title">
					...
					<li class="best3" >
						...
						<div class="cover">
							<a href="textbookDetail.do?goods_num=11">
								<img src="/namuduri/admin/upload/textbook_1507382413535.jpg" alt="82년생 김지영(오늘의 젊은 작가 13)(양장본 HardCover)" />
								<div><em>
												문학성과 다양성, 참신성을 기치로 한국문학의 미래를 이끌어 갈 신예들의 작품을 엄선한 「오늘의 젊은...
								</em><span></span></div>
							</a>
						</div>
						<div class="title">
					...
					<li class="best5" >
						...
						<div class="cover">
							<a href="textbookDetail.do?goods_num=15">
								...
								<div><em>
												『주진우의 이명박 추격기』는 지난 10년 동안 돈 앞에서는 사랑도, 자식도 없는 이명박의 사라진 돈...
								</em><span></span></div>
							</a>
						</div>
						<div class="title">
					...
					<li class="best7" >
						...
						<div class="cover">
							<a href="textbookDetail.do?goods_num=12">
								...
								<div><em>
												강연과 다큐를 결합한 KBS의 렉처멘터리 《명견만리》는 김난도, 김영란, 최재천 등 각 분야의 최고...
								</em><span></span></div>
							</a>
						</div>
						<div class="title">
					...
					<li class="best8" >
						...
						<div class="cover">
							<a href="textbookDetail.do?goods_num=2">
								...
								<div><em>
												무라카미 하루키가 7년 만에 선보인 본격 장편소설 『기사단장 죽이기』제1권. ‘이것이 하루키다!’라...
								</em><span></span></div>
							</a>
						</div>
						<div class="title">
					...
					<li class="best10" >
						...
						<div class="cover">
							<a href="textbookDetail.do?goods_num=17">
								...
								<div><em>
												“어른이 되어보니 세상은 냉담한 곳이었다.” 김수현은 책을 펴내면서 이런 말을 했다. 부조리가 넘쳐...
								</em><span></span></div>
							</a>
						</div>
						<div class="title">
	...
	<div class="content_middle">
		<div class="main_both" style="margin-left: 30px;">
			...
			<div class="box_welcome_best">
				<h2 class="title_welcome_basic">
					이주의 책 <!-- <small>출판사가 추천하는 한주간의 책입니다.</small> -->
				</h2>
			<ul class="list_welcome_best">
			
				<li id="itsbest1"><a href ="textbookDetail.do?goods_num=18"><img src ="/namuduri/admin/upload/textbook_1507402217091.jpg" width ="120" height="200" /></a></li>
				<li id="itsbest2"><a href ="textbookDetail.do?goods_num=19"><img src ="/namuduri/admin/upload/textbook_1507402487739.jpg" width ="120" height="200" /></a></li>
				<li id="itsbest3"><a href ="textbookDetail.do?goods_num=20"><img src ="/namuduri/admin/upload/textbook_1507402586943.jpg" width ="120" height="200" /></a></li>
				<li id="itsbest4"><a href ="textbookDetail.do?goods_num=21"><img src ="/namuduri/admin/upload/textbook_1507402689531.jpg" width ="120" height="200" /></a></li>
				<li id="itsbest5"><a href ="textbookDetail.do?goods_num=22"><img src ="/namuduri/admin/upload/textbook_1507402808274.jpg" width ="120" height="200" /></a></li>
				<li id="itsbest6"><a href ="textbookDetail.do?goods_num=23"><img src ="/namuduri/admin/upload/textbook_1507403006824.jpg" width ="120" height="200" /></a></li>
			</ul>
		</div>
	</div><!-- .main_both -->
</div><!-- .content_middle -->
