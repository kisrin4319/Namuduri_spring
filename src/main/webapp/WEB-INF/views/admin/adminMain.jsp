                  ...
                  <div class="row">
                    <div class="col-sm-12 col-lg-9">
                     	<div class="row col-sm-6 col-lg-12">
                     		<div class="col-lg-4"><div id="pie_chart1"></div></div>
                     		<div class="col-lg-4"><div id="pie_chart2"></div></div>
                     		<div class="col-lg-4"><div id="pie_chart3"></div></div>
                     	</div>
                     	<div class="row col-sm-6 col-lg-12">
                     		<div class="col-lg-4"><div id="pie_chart4"></div></div>
                     		<div class="col-lg-4"><div id="pie_chart5"></div></div>
                     		<div class="col-lg-4"><div id="pie_chart6"></div></div>
                     	</div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                      ...
                      <ul class="icons-list">
                      <c:choose>
                      	<c:when test="${todayBookC==0}"><li style="text-align:center;">No Data</li></c:when>
                      	<c:otherwise>
                        ...
                        <li class="divider text-center">
                          <button type="button" class="btn btn-sm btn-link text-muted" onclick="window.location.href='<%=cp%>/admin/chart/book.do'"
                          data-toggle="tooltip" data-placement="top" title="show more"><i class="icon-options"></i></button>
                        </li>
                      </ul>
                    </div>
                  </div>
