						...
						<div class="panel">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="password" name="board_pw" id="passwd" value="${boardModel.board_pw}" class="form-control rut" maxlength="20">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label" for="name">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="board_title" id="title" value="${boardModel.board_title}" maxlength="50">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label" for="name">
									...
									<div class="col-sm-8">
										<textarea class="form-control" name="board_content" id="content" rows="6">${boardModel.board_content}</textarea>
									</div>
								</div>
