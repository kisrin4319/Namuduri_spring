		...
		<br>
			...
			<table class="boardWrite" width="770" border="0" cellspacing="0" cellpadding="0">
				...
				<tr style="height: 30px;">
					...
					<td>
						<input type="text" name="board_pw" id="passwd" value="${boardModel.board_pw}" style="width: 150px; height: 18px;" maxlength="20" />
					</td>
				</tr>
				<tr>
					<th height="30">
					...
					<td colspan="5" width="770" bgcolor="#FFFFFF">
						<input type="text" name="board_title" id="title" value="${boardModel.board_title}" style="width: 600px; height: 20px;" maxlength="50" />
					</td>
				</tr>
				<tr>
					<th bgcolor="#F4F4F4">
