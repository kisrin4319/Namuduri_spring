					...
					<form name="orderform" id="orderform" method="post">
						...
						<div class="order-page">
							<div class="step-top">
								<h2>주문서작성/결제</h2>
								<div>
									<span><strong>01</strong> 장바구니</span> <span class="this" title="현재페이지"><strong>02</strong> 주문서작성/결제</span> <span class="end"><strong>03</strong> 주문완료</span>
								</div>
							</div>
										...
										<c:forEach var="check" items="${selectList}">
											...
											<tr>
												<td class="gi this-product" style="padding-left: 80px;">
													<div>
														<a href="<%=cp%>/books/bookDetail.do?goods_num=${check.basket_book_num}"> <img src="<%=cp%>/upload/${check.basket_book_image}" width="40" alt="${check.basket_book_name}" title="${check.basket_book_name}" class="middle" class="imgsize-s" />
														</a> ${check.basket_book_name} </a>
													</div>
												</td>
												<td class="ta-c count this-product">${check.basket_book_count}개</td>
												<td class="ta-c this-product"><strong class="price"><fmt:formatNumber value="${check.basket_book_price}" pattern="###,###,###" />원</strong></td>
												<td class="ta-c"><strong class="price"> <b> <fmt:formatNumber value="${check.basket_book_count * check.basket_book_price}" pattern="###,###,###" />원
													</b>
												</strong></td>
											</tr>
										</c:forEach>
							...
							<div class="price-box">
								<div>
									<p>
										<span class="detail"> 총 <em id="totalGoodsCnt">${fn:length(selectList)}</em> 개의 상품금액
							...
							<div class="terms not-member termAgree-check">
								<fieldset>
									...
									<input type="checkbox" name="termAgreeAgreement" id="termAgree_agreement" class="checkbox require" /> <strong class="c-red">(필수)</strong> 이용약관에 대한 내용을 확인 하였으며 이에 동의 합니다.
								</fieldset>
							</div>
							<div class="join-form">
										...
										<table>
											...
											<tbody>
												...
												<tr>
													...
													<td><span class="txt-field hs" style="width: 160px;"> <input type="text" name="order_phone" value="${mresultClass.member_phone }" maxlength="20" class="text" readonly="readonly" />
													</span></td>
												</tr>
												<tr>
													<th class="ta-l required">휴대폰 번호</th>
													<td><span class="txt-field hs" style="width: 160px;"> <input type="text" name="order_mobile" value="${mresultClass.member_mobile }" maxlength="20" class="text" readonly="readonly" />
													</span></td>
												</tr>
												<tr>
													...
													<td>
														<div class="email">
															<span class="txt-field hs" style="width: 160px;"> <input type="text" name="order_email" value="${mresultClass.member_email }" class="text" />
															</span>
														</div>
													</td>
												</tr>
										...
										<table>
											...
											<tbody>
												<tr>
													...
													<td><input type="radio" name="shipping" id="shippingNew" class="radio" checked="" onclick="deldata();" />직접 입력 <input type="radio" name="shipping" id="shippingSameCheck" class="radio" onclick="senddata();" />주문자정보와 동일</td>
												</tr>
												<tr>
													...
													<td>
														<div class="post">
															<div class="txt-field hs" style="width: 120px;">
																<input type="text" name="order_receive_zipcode" value="" readonly="readonly" class="text" /> <span id="receiverZipcodeText" class="text"></span>
															</div>
															<button type="button" onclick="orderzipCheck()" class="normal-btn small2 post-search">
																<em>우편번호검색</em>
															</button>
														</div>
														<div class="sa">
															<span class="txt-field hs" style="width: 400px;"> <input type="text" name="order_receive_addr1" value="" readonly="readonly" class="text" />
															</span> <span class="txt-field hs" style="width: 300px;"> <input type="text" name="order_receive_addr2" value="" class="text" />
															</span>
														</div>
													</td>
												</tr>
												<tr>
													<th class="ta-l">전화번호</th>
													<td><span class="txt-field hs" style="width: 160px;"> <input type="text" id="order_receive_phone" name="order_receive_phone" value="" class="text" />
													</span></td>
												</tr>
												<tr>
													<th class="ta-l required">휴대폰 번호</th>
													<td><span class="txt-field hs" style="width: 160px;"> <input type="text" id="order_receive_mobile" name="order_receive_mobile" value="" class="text" />
													</span></td>
												</tr>
												<tr>
												...
												<div class="process" id="settlekind_general">
													...
													<div class="selection" style="text-align: left;">
														<div style="padding-left: 23px;">
															<input type="radio" name="settleKind" id="settleKind_gb" value="gb" class="radio" /> 무통장 입금
														</div>
														<!-- 무통장입금 컨텐츠 -->
														<ul class="bank" id="settlekind_general_gb">
															...
															<li><strong>입금자명</strong>
																<div>
																	<span class="txt-field hs"> <input type="text" name="order_trade_payer" class="text" />
																	</span>
																</div></li>
