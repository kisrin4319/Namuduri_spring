   			...
   			<table>
   				<tbody>
   					<tr>
   						...
   						<td>
   							<p>
   								...
   								예금주명 : 나무두리(주)
   								입금금액 : <strong class ="c-red"><s:property value="order_goods_price*order_goods_count"/>원</strong>
   					...
   					<tr>
                    	...
                    	<td><s:property value ="oparamClass.order_goods_name"/></td>
               		</tr>
                	...
                	<tr>
              		...
              		<tr>
                    	...
                    	<td><strong><s:property value ="order_goods_price"/></strong><span class="add_currency"></span></td>
                	</tr>
                	
                	<tr>
                		<th class ="ta-l">총 결제금액</th>
                		<td><strong class ="c-red"><s:property value ="%{oparamClass.order_goods_price*oparamClass.order_goods_count}"/></strong><span class="add_currency"></span></td>
                	</tr>
   				</tbody>
   					<colgroup>
