											...
											<c:forEach var="wish" items="${wishList}">
												...
												<tr>
													...
													<td class="product-details">
														...
														<input type="text" placeholder="Please Enter Your Comment" size="35" value="${wish.wish_comment}" id="${wish.wish_num }" style="margin-bottom: 5px;"><br/>
														<input type="button" value="EDIT A COMMENT" onclick="Modify(${wish.wish_book_num },${wish.wish_num });" class="btn btn-warning" style="height:27px; width: 130px; border-left-width: 0px; adding-left: 5px; padding-right: 5px; border-right-width: 0px; padding-top: 3px; border-top-width: 0px; padding-left: 5px; padding-bottom: 3px; margin-bottom: 2px;">
													</td>
													...
													<td class="product-remove">
														<a href="javascript:Delete(${wish.wish_num})">
															<i class="flaticon-delete" style="color: #f0ad4e;"></i>
														</a>
													</td>
												</tr>
											</c:forEach>
