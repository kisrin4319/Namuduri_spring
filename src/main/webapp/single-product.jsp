                    ...
                    <div class="col-md-6 col-sm-7">
                        <div class="single-product-image-inner">
                            ...
                            <ul class="product-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#one" aria-controls="one" role="tab" data-toggle="tab"><img src="${pageContext.request.contextPath}/bootstrap/img/single-product/1.jpg" alt=""></a></li>
                                <li role="presentation"><a href="#two" aria-controls="two" role="tab" data-toggle="tab"><img src="${pageContext.request.contextPath}/bootstrap/img/single-product/2.jpg" alt=""></a></li>
                                <li role="presentation"><a href="#three" aria-controls="three" role="tab" data-toggle="tab"><img src="${pageContext.request.contextPath}/bootstrap/img/single-product/3.jpg" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
